...
class RecordLayer(object):
    ...
    def sendRecord(self, msg):
        ...
        ## zombie
        self.plaintextMessage.append(data[:])
        ...
        # zombie
        self.ciphertextMessage.append(encryptedMessage)
        # client key: _recordLayer.writeState.encContext.key, _recordLayer.writeState.fixedNonce
        # server key: _recordLayer.readState.encContext.key, _recordLayer.readState.fixedNonce
