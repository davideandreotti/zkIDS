...
public class TLSKeySchedule {
  ...
  public static UnsignedInteger[][] get1RTT_HS_new(UnsignedInteger[] HS, UnsignedInteger[] H2, UnsignedInteger CH_SH_len, UnsignedInteger ServExt_len, UnsignedInteger[] ServExt_ct_tail, UnsignedInteger ServExt_tail_len, UnsignedInteger[] SHA_H_Checkpoint, UnsignedInteger[] appl_ct) {
    ...
    // Derive the SF value  
    UnsignedInteger[] fk_S = HKDF.hkdf_expand_derive_secret(SHTS, "finished", (UnsignedInteger[]) UnsignedInteger.createZeroArray(null, new int[]{0}, 8));
    ...
    UnsignedInteger[] SF_transcript = (UnsignedInteger[]) UnsignedInteger.createZeroArray(null, new int[]{32}, 8);
    ...
    UnsignedInteger[] dns_plaintext = AES_GCM.aes_gcm_decrypt(tk_capp, iv_capp, appl_ct);
    //System.out.println(String.format("%x", dns_plaintext[3].getBitElements()));
    return new UnsignedInteger[][]{dns_plaintext, tk_shs, iv_shs, tk_capp, iv_capp, H_3, SF_calculated};
    
  }
public static String channel_test_file_name;
public static int HEIGHT;
public static UnsignedInteger[] HS;
public static UnsignedInteger[] SHA_H_Checkpoint;
public static UnsignedInteger[] H2;
public static UnsignedInteger CH_SH_len;
public static UnsignedInteger ServExt_len;
public static UnsignedInteger[] ServExt_tail_ct;
public static UnsignedInteger ServExt_tail_len;
public static UnsignedInteger[] dns_ct;
public static FieldElement root;
public static UnsignedInteger[] left_domain_name;
public static UnsignedInteger[] right_domain_name;
public static FieldElement[] left_path_array;
public static FieldElement[] right_path_array;
public static UnsignedInteger left_dir;
public static UnsignedInteger right_dir;
public static UnsignedInteger left_index;
public static UnsignedInteger right_index;
public static UnsignedInteger[][] values;
