...
public class ZKMB extends CircuitGenerator {
  ...
  public void __init() {
    channel_test_file_name = "transcript_baseline.txt";
  ...
  public void outsource() {
    ...
    UnsignedInteger[][] extraction_values = LabelExtraction.extractDoHGETReverse(dns_query_bytes);
