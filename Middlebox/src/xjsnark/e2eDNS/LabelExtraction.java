...
public class LabelExtraction {
  ...
  public static UnsignedInteger[][] deserializeQuestion(UnsignedInteger[] dns_message, int offset) {
    ...
    for (int i = 0; i + offset < 255; i++) {
      {
        Bit bit_a0i0t = UnsignedInteger.instantiateFrom(8, i + offset).isNotEqualTo(skip_index).copy();
        boolean c_a0i0t = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0i0t);
        if (c_a0i0t) {
          if (bit_a0i0t.getConstantValue()) {
            all_labels[i].assign(dns_message[i + offset].mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          } else {
            {
              Bit bit_a0a0a0a2a0a8a91 = dns_message[i + offset].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
              boolean c_a0a0a0a2a0a8a91 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a0a2a0a8a91);
              if (c_a0a0a0a2a0a8a91) {
                if (bit_a0a0a0a2a0a8a91.getConstantValue()) {
                ...
                ConditionalScopeTracker.push(bit_a0a0a0a2a0a8a91);
                true_length.assign(true_length.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0i0t);
          all_labels[i].assign(dns_message[i + offset].mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          {
            Bit bit_a0a0a8a91_0 = dns_message[i + offset].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
            boolean c_a0a0a8a91_0 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a8a91_0);
            if (c_a0a0a8a91_0) {
              if (bit_a0a0a8a91_0.getConstantValue()) {
                true_length.assign(true_length.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
              } else {
              ...
              ConditionalScopeTracker.pushMain();
              ConditionalScopeTracker.push(bit_a0a0a8a91_0);
              true_length.assign(true_length.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              skip_index.assign(skip_index.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
  ...
  public static UnsignedInteger[][] deserializeQuestion(UnsignedInteger[] dns_message, UnsignedInteger offset) {
    ...
    for (int i = 0; i < 255; i++) {
      {
        Bit bit_a0m0w = UnsignedInteger.instantiateFrom(8, i).add(offset).isNotEqualTo(skip_index).copy();
        boolean c_a0m0w = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0m0w);
        if (c_a0m0w) {
          if (bit_a0m0w.getConstantValue()) {
            ...
            {
              Bit bit_a0a0a0a2a0a21a22 = dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)).isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
              boolean c_a0a0a0a2a0a21a22 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a0a2a0a21a22);
              if (c_a0a0a0a2a0a21a22) {
                if (bit_a0a0a0a2a0a21a22.getConstantValue()) {
                ...
                ConditionalScopeTracker.pushMain();
                ConditionalScopeTracker.push(bit_a0a0a0a2a0a21a22);
                true_length.assign(true_length.add(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0m0w);
          all_labels[i].assign(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          {
            Bit bit_a0a0a21a22_0 = dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)).isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
            boolean c_a0a0a21a22_0 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a21a22_0);
            if (c_a0a0a21a22_0) {
              if (bit_a0a0a21a22_0.getConstantValue()) {
                true_length.assign(true_length.add(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
              } else {
              ...
              ConditionalScopeTracker.pushMain();
              ConditionalScopeTracker.push(bit_a0a0a21a22_0);
              true_length.assign(true_length.add(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              skip_index.assign(skip_index.add(dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
  ...
  public static UnsignedInteger[][] extractDoHGET(UnsignedInteger[] http_bytes) {
    ...
    for (int i = 0; i < DNS_QUERY_MAX_B64_LENGTH; i++) {
      {
        Bit bit_a0p0ac = seen_space.isEqualTo(UnsignedInteger.instantiateFrom(1, 0)).copy();
        boolean c_a0p0ac = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0p0ac);
        if (c_a0p0ac) {
          if (bit_a0p0ac.getConstantValue()) {
            {
              Bit bit_a0a0a2a0a51a25 = http_bytes[i + 19].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 32)).copy();
              boolean c_a0a0a2a0a51a25 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a2a0a51a25);
              if (c_a0a0a2a0a51a25) {
                if (bit_a0a0a2a0a51a25.getConstantValue()) {
                ...
                ConditionalScopeTracker.pushMain();
                ConditionalScopeTracker.push(bit_a0a0a2a0a51a25);
                wire_format_base64[i].assign(http_bytes[i + 19], 8);
                wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0p0ac);
          {
            Bit bit_a0a0p0ac = http_bytes[i + 19].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 32)).copy();
            boolean c_a0a0p0ac = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0p0ac);
            if (c_a0a0p0ac) {
              if (bit_a0a0p0ac.getConstantValue()) {
                wire_format_base64[i].assign(http_bytes[i + 19], 8);
                wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
              } else {
                seen_space.assign(UnsignedInteger.instantiateFrom(1, 1), 1);
              ...
              ConditionalScopeTracker.pushMain();
              ConditionalScopeTracker.push(bit_a0a0p0ac);
              wire_format_base64[i].assign(http_bytes[i + 19], 8);
              wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
  ...
  public static UnsignedInteger[][] extractURLGET(UnsignedInteger[] http_bytes) {
    ...
    // first verify that the query is a get 
    UnsignedInteger[] first_four_get = UnsignedInteger.instantiateFrom(8, first_four_get_bytes_int);
    check_method(http_bytes_ram, first_four_get);

    UnsignedInteger[] url = (UnsignedInteger[]) UnsignedInteger.createZeroArray(CircuitGenerator.__getActiveCircuitGenerator(), new int[]{DNS_QUERY_MAX_B64_LENGTH}, 8);
    UnsignedInteger seen_space = UnsignedInteger.instantiateFrom(1, 0).copy(1);
    UnsignedInteger wf_length = UnsignedInteger.instantiateFrom(16, 0).copy(16);
    for (int i = 0; i < DNS_QUERY_MAX_B64_LENGTH; i++) {
      {
        Bit bit_a0n0cc = seen_space.isEqualTo(UnsignedInteger.instantiateFrom(1, 0)).copy();
        boolean c_a0n0cc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0n0cc);
        if (c_a0n0cc) {
          if (bit_a0n0cc.getConstantValue()) {
            {
              Bit bit_a0a0a2a0a31a45 = http_bytes[i + 5].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 32)).copy();
              boolean c_a0a0a2a0a31a45 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a2a0a31a45);
              if (c_a0a0a2a0a31a45) {
                if (bit_a0a0a2a0a31a45.getConstantValue()) {
                  url[i].assign(http_bytes[i + 5], 8);
                  wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
                } else {
                  seen_space.assign(UnsignedInteger.instantiateFrom(1, 1), 1);
                ...
                ConditionalScopeTracker.pushMain();
                ConditionalScopeTracker.push(bit_a0a0a2a0a31a45);
                url[i].assign(http_bytes[i + 4], 8);
                wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
            ...
            url[i].assign(UnsignedInteger.instantiateFrom(8, 0), 8);

          }
        } else {
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0n0cc);
          {
            Bit bit_a0a0n0cc = http_bytes[i + 4].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 32)).copy();
            boolean c_a0a0n0cc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0n0cc);
            if (c_a0a0n0cc) {
              if (bit_a0a0n0cc.getConstantValue()) {
                url[i].assign(http_bytes[i + 4], 8);
                wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
              } else {
                seen_space.assign(UnsignedInteger.instantiateFrom(1, 1), 1);
              ...
              ConditionalScopeTracker.pushMain();
              ConditionalScopeTracker.push(bit_a0a0n0cc);
              url[i].assign(http_bytes[i + 4], 8);
              wf_length.assign(wf_length.add(UnsignedInteger.instantiateFrom(16, 1)), 16);
    ...
    UnsignedInteger[] converted = url;
    UnsignedInteger url_length = UnsignedInteger.instantiateFrom(8, url.length).copy(8);
    UnsignedInteger true_length = UnsignedInteger.instantiateFrom(8, 0).copy(8);


    return new UnsignedInteger[][]{url, new UnsignedInteger[]{url_length.copy(8)}};
  }
  ...
  public static UnsignedInteger[] reverse(UnsignedInteger[] input, UnsignedInteger rev_length) {
    ...
    for (int i = 0; i < input.length; i++) {
      {
        Bit bit_a0e0fc = UnsignedInteger.instantiateFrom(8, i).isLessThan(rev_length).copy();
        boolean c_a0e0fc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0e0fc);
        if (c_a0e0fc) {
          if (bit_a0e0fc.getConstantValue()) {
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0e0fc);
          output[i].assign(input_ram.read(UnsignedInteger.instantiateFrom(8, rev_length.subtract(UnsignedInteger.instantiateFrom(8, i)).subtract(UnsignedInteger.instantiateFrom(8, 1)))), 8);
