...
template<typename ppT>
r1cs_gg_ppzksnark_keypair<ppT> run_r1cs_gg_ppzksnark_generateparameters(const r1cs_example<libff::Fr<ppT> > &example,
                        const bool test_serialization)
{
    libff::enter_block("Call to GENERATION");
    ...
    libff::leave_block("Call to GENERATION");
    return(keypair);
}
