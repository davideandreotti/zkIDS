...
public class Test_HTTP_Merkle_Token extends CircuitGenerator {
  ...
  public static void main(String[] args) {
    ...
    randomid = args[4];
    pktnum = args[5];
    MAX_DNS_CT_LEN = Integer.parseInt(args[6]);
    MAX_URL_LEN = Integer.parseInt(args[7]);
    HEIGHT = Integer.parseInt(args[8]);
    TOKEN_LEN = Integer.parseInt(args[9]);

    new Test_HTTP_Merkle_Token(args);
  }

  public Test_HTTP_Merkle_Token(String[] s) {
    super("Test_HTTP_Merkle_Token");
    __generateCircuit();
    if (s[0].equals("pub")) {
  ...
  public static int MAX_DNS_CT_LEN = 500;
  public static int MAX_URL_LEN = 20;
  public static int HEIGHT;
  public static int TOKEN_LEN = 6;
  @Override
