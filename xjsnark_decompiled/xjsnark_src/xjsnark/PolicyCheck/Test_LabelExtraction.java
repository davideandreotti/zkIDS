...
public class Test_LabelExtraction {
  ...
  public static UnsignedInteger[][] deserializeQuestion(UnsignedInteger[] dns_message, int offset) {
    ...
    for (int i = 0; i + offset < 255; i++) {
      {
        Bit bit_a0i0w_0 = UnsignedInteger.instantiateFrom(8, i + offset).isNotEqualTo(skip_index).copy();
        boolean c_a0i0w_0 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0i0w_0);
        if (c_a0i0w_0) {
          if (bit_a0i0w_0.getConstantValue()) {
            all_labels[i].assign(dns_message[i + offset].mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          } else {
            {
              Bit bit_a0a0a0a2a0a8a22_0 = dns_message[i + offset].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
              boolean c_a0a0a0a2a0a8a22_0 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a0a2a0a8a22_0);
              if (c_a0a0a0a2a0a8a22_0) {
                if (bit_a0a0a0a2a0a8a22_0.getConstantValue()) {
                ...
                ConditionalScopeTracker.push(bit_a0a0a0a2a0a8a22_0);
                true_length.assign(true_length.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0i0w_0);
          all_labels[i].assign(dns_message[i + offset].mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          {
            Bit bit_a0a0a8a22_2 = dns_message[i + offset].isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
            boolean c_a0a0a8a22_2 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a8a22_2);
            if (c_a0a0a8a22_2) {
              if (bit_a0a0a8a22_2.getConstantValue()) {
                true_length.assign(true_length.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
              } else {
              ...
              ConditionalScopeTracker.pushMain();
              ConditionalScopeTracker.push(bit_a0a0a8a22_2);
              true_length.assign(true_length.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              skip_index.assign(skip_index.add(dns_message[i + offset]).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
  ...
  public static UnsignedInteger[][] deserializeQuestion(UnsignedInteger[] dns_message, UnsignedInteger offset) {
    ...
    for (int i = 0; i < 255; i++) {
      {
        Bit bit_a0m0z_0 = UnsignedInteger.instantiateFrom(8, i).add(offset).isNotEqualTo(skip_index).copy();
        boolean c_a0m0z_0 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0m0z_0);
        if (c_a0m0z_0) {
          if (bit_a0m0z_0.getConstantValue()) {
            ...
            {
              Bit bit_a0a0a0a2a0a21a52_0 = dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)).isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
              boolean c_a0a0a0a2a0a21a52_0 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a0a2a0a21a52_0);
              if (c_a0a0a0a2a0a21a52_0) {
                if (bit_a0a0a0a2a0a21a52_0.getConstantValue()) {
                ...
                ConditionalScopeTracker.pushMain();
                ConditionalScopeTracker.push(bit_a0a0a0a2a0a21a52_0);
                true_length.assign(true_length.add(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0m0z_0);
          all_labels[i].assign(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
          ...
          {
            Bit bit_a0a0a21a52_2 = dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)).isNotEqualTo(UnsignedInteger.instantiateFrom(8, 0)).copy();
            boolean c_a0a0a21a52_2 = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0a0a21a52_2);
            if (c_a0a0a21a52_2) {
              if (bit_a0a0a21a52_2.getConstantValue()) {
                true_length.assign(true_length.add(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                skip_index.assign(skip_index.add(dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
                all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
              } else {
              ...
              ConditionalScopeTracker.pushMain();
              ConditionalScopeTracker.push(bit_a0a0a21a52_2);
              true_length.assign(true_length.add(UnsignedInteger.instantiateFrom(8, dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset)))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              skip_index.assign(skip_index.add(dns_message_ram.read(UnsignedInteger.instantiateFrom(8, i).add(offset))).add(UnsignedInteger.instantiateFrom(8, 1)), 8);
              all_labels[i].assign(UnsignedInteger.instantiateFrom(8, 46).mul(UnsignedInteger.instantiateFrom(8, keep_reading)), 8);
  ...
  public static UnsignedInteger[] reverse(UnsignedInteger[] input, UnsignedInteger rev_length) {
    ...
    for (int i = 0; i < input.length; i++) {
      {
        Bit bit_a0e0bc = UnsignedInteger.instantiateFrom(8, i).isLessThan(rev_length).copy();
        boolean c_a0e0bc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0e0bc);
        if (c_a0e0bc) {
          if (bit_a0e0bc.getConstantValue()) {
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0e0bc);
          output[i].assign(input_ram.read(UnsignedInteger.instantiateFrom(8, rev_length.subtract(UnsignedInteger.instantiateFrom(8, i)).subtract(UnsignedInteger.instantiateFrom(8, 1)))), 8);
  ...
  private static UnsignedInteger get_first_crlf_index(UnsignedInteger[] http_msg) {
    ...
    for (int i = 1; i < Test_HTTP_Merkle_Token.MAX_DNS_CT_LEN; i++) {
      ...
      {
        Bit bit_j0o0jc = CRLF_CONCAT.isEqualTo(curr_concat).copy();
        boolean c_j0o0jc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_j0o0jc);
        if (c_j0o0jc) {
          if (bit_j0o0jc.getConstantValue()) {
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_j0o0jc);
  ...
  private static void match_http_string(SmartMemory<UnsignedInteger> http_msg_ram, int first_char_index, UnsignedInteger[] allowed_url, UnsignedInteger url_len) {
    ...
    for (int i = 0; i < Test_HTTP_String.MAX_URL_LEN; i++) {
      {
        Bit bit_a0i0mc = UnsignedInteger.instantiateFrom(8, i).isLessThan(url_len).copy();
        boolean c_a0i0mc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0i0mc);
        if (c_a0i0mc) {
          if (bit_a0i0mc.getConstantValue()) {
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0i0mc);
          http_msg_ram.read(first_char_index + i).forceEqual(allowed_url[i]);
  ...
  private static void match_http_merkle(SmartMemory<UnsignedInteger> http_msg_ram, int first_char_index, UnsignedInteger[] allowed_url, UnsignedInteger url_len) {
    UnsignedInteger[] http11 = UnsignedInteger.instantiateFrom(8, http11_ints);
    UnsignedInteger[] query = UnsignedInteger.instantiateFrom(8, query_ints);
    UnsignedInteger keep_reading = UnsignedInteger.instantiateFrom(1, 1).copy(1);

    for (int i = 0; i < Test_HTTP_Merkle.MAX_URL_LEN; i++) {
      {
        Bit bit_a0e0nc = UnsignedInteger.instantiateFrom(8, i).isLessThan(url_len).copy();
        boolean c_a0e0nc = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_a0e0nc);
        if (c_a0e0nc) {
          if (bit_a0e0nc.getConstantValue()) {
            http_msg_ram.read(first_char_index + i).forceEqual(allowed_url[i]);
          } else {
          ...
          ConditionalScopeTracker.pushMain();
          ConditionalScopeTracker.push(bit_a0e0nc);
          http_msg_ram.read(first_char_index + i).forceEqual(allowed_url[i]);
  ...
  public static UnsignedInteger[] firewall_string(UnsignedInteger[] http_msg, UnsignedInteger[] allowed_url, UnsignedInteger url_length) {
    ...
    match_http_string(http_msg_ram, first_char_index, allowed_url, url_length.copy(8));
    return http_msg;
  }
  public static UnsignedInteger[] firewall_merkle(UnsignedInteger[] http_msg, UnsignedInteger[] allowed_url, UnsignedInteger url_length) {
    // Get the first index where CRLF appears 
    // TODO: could we use the assumption that the first 4 are "GET "? 
    int first_char_index = 4;
    // Create a RAM from the http message. 
    ...
    SmartMemory<UnsignedInteger> http_msg_ram = new SmartMemory(UnsignedInteger.instantiateFrom(8, http_msg), UnsignedInteger.__getClassRef(), new Object[]{"8"});
    // Verifies the http string before the CRLF 
    match_http_merkle(http_msg_ram, first_char_index, allowed_url, url_length.copy(8));
    return http_msg;
  }
  ...
  public static UnsignedInteger check_token(UnsignedInteger[] http_msg, UnsignedInteger[] token, UnsignedInteger token_length) {
    ...
    SmartMemory<UnsignedInteger> http_msg_ram = new SmartMemory(UnsignedInteger.instantiateFrom(8, http_msg), UnsignedInteger.__getClassRef(), new Object[]{"8"});
    for (int i = 0; i < Test_HTTP_Merkle_Token.TOKEN_LEN; i++) {
